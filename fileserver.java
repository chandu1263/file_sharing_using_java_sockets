...
public class fileserver extends Thread{
    ...
    public fileserver(int port, int udpport){
        try{
            sersocket = new ServerSocket(port);
            udp_soc = new DatagramSocket(udpport);
            System.out.println("Server getting ready.............");
    ...
    public void run(){
        try{
            while(true){
                ...
                String commandRcvd = dis.readUTF();
                System.out.println(commandRcvd);
                String[] parsedrevcdcmd = commandRcvd.split(":");
            ...
            // ------------------------------ file upload ----------------------------------//
                    ...
                    if(userpersocket.containsKey(parsedrevcdcmd[3])){
                        ...
                        try{
                            ...
                            System.out.println("ERROR: An error occured while uploading the file!!!");
                            System.out.println("Server:>>");
                            e.printStackTrace();
                        }
                    }
    ...
    public static void main(String[] args) throws IOException, UnknownHostException{
        int port = 3060;
        int udpport = 3061;
        fileserver filser = new fileserver(port, udpport);
        filser.start();
    }
}